...
우리는 예측하는 능력이 꽤나 뛰어나다. 허나 놀라운 일을 예측하지 못할 뿐이고, 그 놀라운 일이 모든 것을 좌우하기도 한다. 다만 여기서 이분법에 빠지면 안 된다. 예측하지 못하는 것들이 모든 것을 바꾸니까 예측하기를 멈추거나, 반대로 예측을 맹신하는 등 말이다. 어디까지나 예측하는 하려고 노력해야 하고, 예측하지 못하는 것들에 대해 겸손해야 한다. 예측이 불가능하니까 하지 말자라던지, 모든 것을 예측 가능하다고 믿는다던지 하는 이분법에 빠지면 안된다.
