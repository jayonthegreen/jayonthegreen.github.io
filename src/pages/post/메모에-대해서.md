---
title: 애플펜슬을 팔았다
description: "\b다시 아날로그 메모장으로 돌아가자"
date: 2025-09-21
tags:
  - 메모
  - memo
  ...
  - 생산성
---
나는 메모를 좋아한다. 특히 노란색 리갈패드에 남기는 걸 좋아한다. 아이패드로 그 경험을 옮겨보고자 애플펜슬 프로를 샀지만, 만족스럽지 않아 최근에 중고로 팔았다.

애플펜슬은 종이처럼 빠르게 휘갈겨 쓸 수 없다. 종이는 생각을 거침없이 흘려보내게 하지만, 애플펜슬로 남긴 기록은 의외로 크게 남는 게 없다. 차라리 메모를 하고 일주일에 한 번 추려 타이핑하는 편이 낫다.

관찰하고, 생각하고, 정리하는 것이 중요하다. 이건 하면 할수록 는다. 생각이 정리되어야 표현도 깔끔해진다. AI 시대에는 더더욱, 나의 말을 정확히 글로 풀어 쓸 수 있어야 한다.
