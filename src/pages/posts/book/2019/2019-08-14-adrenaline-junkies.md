...
이 책은 지금 회사의 CTO님으로부터 추천받았다. 첫 직장에서는 6명에서 10명정도의 개발자가 하나의 팀으로 프로젝트를 했다. 두번째 회사의 개발팀은 이미 팀 전체가 하나의 프로젝트를 하지 않는 상태였다. 따라서 개개인의 프로젝트 관리 능력에 따라, 프로젝트의 외부 요인에 따라 다양한 상황들이 펼쳐졌다. 개인적으로는 도전적인 환경이었다. 2인용 자전거 뒷자리를 타다가 외발자전거를 타면서 배드민턴을 치는 느낌이라고 비유하면 적절할 것이다. 다소 동시다발적으로 크고 작은 일이 진행되었다. 더불어 직장은 커머스 도메인이라 그런지 모르겠지만, 코드와 현실의 복잡도 대비 장애발생은 높았고 그 민감도가 매우 높았다. 이 와중에 이전 직장에서 기획자, PM, QA가 해주던 업무들이 다소 개발자가 직접하는 업무 형태를 가지고 있었다. 첫직장에서는 프로젝트 진행에 있어서 꽤나 매끄러웠다는 걸 이직을 하고나서야 깨달았다. 
