...
많은 회사가 스스로 기술 중심 회사를 표방한다. 비슷한 클리쉐는 고객 중심, 데이터 중심을 이야기하는 것이다. 나는 이런 것들에 공감하지만, 실체 없이 이야기하는 것을 힙스터 처럼 경계한다. '내가 하면 로맨스 남이 하면 불륜'의 양가적인 태도가 있다. 기술, 데이터, 고객 중심의 실체를 탐험하는 관점에서 이 책을 통넷플릭스를 조금 더 알 수 있었다.
