...
description: 2018년이 된 지금, 다시 책을 펼쳤고 이번에는 조금 달랐다. 신기하게도 낯선 개념은 없었고,  내용을 살펴보는 것을 넘어 공감과 생각을 많이 할 수 있는 시간이었다.

---

## 다시 읽다.

개발을 막 시작한 2014년, 나에게 개발을 알려준 형이 [Head First Design Pattern](http://www.hanbit.co.kr/store/books/look.php?p_code=B9860513241)라는 책을 추천하고 읽던 책을 줬다. 처음 책을 접했을 때 많은 내용을 깊히 공감하기 어려웠다. 당시 나의 경험이 절대량이 적어서 그런것 같다. 2018년이 된 지금, 다시 책을 펼쳤고 이번에는 조금 달랐다. 신기하게도 낯선 개념은 없었고,  내용을 살펴보는 것을 넘어 공감과 생각을 많이 할 수 있는 시간이었다. 그래서 읽고 정리하는데도 큰 부담이 없었다.
