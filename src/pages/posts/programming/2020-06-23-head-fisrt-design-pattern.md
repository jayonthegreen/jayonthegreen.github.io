...
description: 개발을 시작한 2014년, 개발을 알려준 형이 이 책을 권하며 줬다. 당시 내용을 깊히 공감하기 어려웠었다. 나의 경험이 절대량이 부족해서 그랬던것 같다. 2018년이 된 지금 다시 책을 펼쳤고 이번엔 달랐다. 낯선 개념은 적었고 공감과 생각을 많이 할 수 있는 시간이었다. 그래서 읽고 정리하는데도 큰 부담이 없었다.

---

## 다시 읽다.

개발을 시작한 2014년, 개발을 알려준 형이 이 책을 권하며 줬다. 당시 내용을 깊히 공감하기 어려웠었다. 나의 경험이 절대량이 부족해서 그랬던것 같다. 2018년이 된 지금 다시 책을 펼쳤고 이번엔 달랐다. 낯선 개념은 적었고 공감과 생각을 많이 할 수 있는 시간이었다. 그래서 읽고 정리하는데도 큰 부담이 없었다.
