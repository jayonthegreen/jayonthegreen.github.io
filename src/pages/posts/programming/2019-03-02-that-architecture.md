...
개발하다 문득 스프링의 서비스란 뭔지에 대해 고민하게 되었다. 더불어 사람들이 서비스를 어떻게 이해하는지가 궁금해졌다. 무엇이 서비스인지 작업자 끼리리 비슷한 생각을 해야한다. 작성만 하던 Service가 무엇인지 확실히 하고 넘어가고 싶었다. `@Service` 어노테이션의 구현 파일을 봤다. 
