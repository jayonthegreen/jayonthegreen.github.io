...
그럼 어떻게 '좋은' 아키텍처를 가져올 수 있을까. 구현과 상관 없이 그 방식이 논리적인 모순이 없고 점검하고, 유저 관점에서 자연스러운지 고민해야 한다. 그러지 않으면 그 모순과 부자연스러움이 아키텍처에도 드러난다. 그러나 현실은 매우 복잡하기에 완벽히 해결할 수 있는 문제는 아니다.
